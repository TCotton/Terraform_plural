...
aws s3 cp s3://${aws_s3_bucket.s3_bucket.id}/website/index.html /home/ec2-user/index.html
aws s3 cp s3://${aws_s3_bucket.s3_bucket.id}/website/Globo_logo_Vert.png /home/ec2-user/Globo_logo_Vert.png
